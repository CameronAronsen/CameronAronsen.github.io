class TechnologyList {
    ...
    showTechnologies(technologies) {
        let myTable = document.getElementById("techList");
        myTable.innerHTML = "<tr><th style='width:5%;'>Number</th><th style='width:15%;'>Name</th><th style='width:45%;'>Application</th><th style='width:15%;'>Cases</th><th style='width:20%;'>Keywords</th></tr>";
